<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="applyStartDate" label="活动报名开始日期" width="150px" align="center"></el-table-column>
      <el-table-column prop="applyEndDate" label="活动报名结束日期" width="150px" align="center"></el-table-column>
      <el-table-column prop="limitedNumber" label="限制报名人数" width="150px" align="center"></el-table-column>
