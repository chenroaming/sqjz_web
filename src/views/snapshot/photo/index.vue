<template>
  <div>
      ...
      <div slot="extraArea" style="white-space:nowrap;height:50px;line-height:50px;text-align:right;padding-right:30px;">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <img :src="scope.row.rPhoto" alt="图片"  style='width:100px;height:100px;cursor:pointer' @click="handleLoogBigPic(scope.row.lPhoto)">
        </template>
      </el-table-column>
      <el-table-column
        prop="similarity"
      ...
      <el-table-column
        ...
        width="180">
        <template slot-scope="scope">
          <img :src="scope.row.uPhoto? scope.row.uPhoto : require('@/assets/icons/defaultuser.jpg')" alt="暂无图片"  style='width:100px;height:100px'>
        </template>
      </el-table-column>
      <el-table-column
        prop="name"
