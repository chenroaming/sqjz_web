...
export default {
  ...
  mounted() {
    ...
    const userInfo = this.$route.params.userId
      ? this.$route.params
      : JSON.parse(window.localStorage.getItem("CommunituserInfo"));
    window.localStorage.getItem("CommunituserInfo") &&
      window.localStorage.removeItem("CommunituserInfo");
    if (!userInfo) {
