...
<script>
  ...
  export default {
    ...
    mounted() {
      // const arr = [{index:['1','2']},{index:['11','22']},{index:['33','123']}]
      // const flatArr = arr.reduce((acc, { index }) => acc.concat(index), [])
      // console.log(flatArr)
      // const arr2 = [];
      ...
      // }
      // console.log(arr2)
      // const arr1 = [{case:{name:[{id:1},{id:2}]}},{case:{name:[{id:3},{id:4}]}}]
      // const flatArr = arr1.reduce((acc, arr2) => acc.concat(arr2.case.name), [])
      // console.log(flatArr)
