<template>
  <el-dialog title="修改规则" width="35%" center :visible.sync="dialogTableVisible">
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      <el-form-item prop="ruleName" label="规则名称">
        <el-input v-model="form.ruleName"></el-input>
      </el-form-item>
      <el-form-item label="任务类型">
        <el-select v-model="form.ruleType" @change="changeType" placeholder="请选择">
          <el-option
      ...
      <el-form-item prop="period" label="每周任意一天" v-if="form.ruleType === 2">
      ...
      <el-form-item prop="period" label="每月任意一天" v-if="form.ruleType === 3">
        <el-select v-model="form.period" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="起止时间">
        <div v-for="(item,index) in form.clockRuleTimes" style="margin-top: 5px;" :key="index">
          <el-time-picker
            is-range
        ...
        <div style="float: left;width: 30px;margin-top: 20px;">
          <el-button type="warning" icon="el-icon-delete" circle @click="delTime" v-if="form.clockRuleTimes.length > 1"></el-button>
        </div>
      </el-form-item>
      <el-form-item>
